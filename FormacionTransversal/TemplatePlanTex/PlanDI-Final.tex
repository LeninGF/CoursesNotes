...
\usepackage[utf8]{inputenc} % optional for modern LaTeX distributions
\usepackage[spanish]{babel}
\usepackage{graphicx}
\usepackage[margin=2.5cm]{geometry} % Single line geometry configuration
\usepackage{lscape}
\usepackage{longtable}
\usepackage{newtxtext,newtxmath} % For Times-like fonts
\usepackage{hyperref} 
\usepackage{multirow}
